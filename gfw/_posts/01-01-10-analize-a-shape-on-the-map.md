...
<div id="desktopContent" class="content">
  ...
  <!-- new image here -->
  <p><%= image_tag('howto-screenshots/analyze-a-shape-on-the-map/Land Use Mining.png') %></p>
  <p><strong>3.</strong> Turn on the Forest Change data layer you wish to analyze or subscribe to (e.g., tree cover loss).</p>
  <p><%= image_tag('howto-screenshots/analyze-a-shape-on-the-map/Forest Change Tree Cover Loss.png') %></p>
  ...
  <p><%= image_tag('howto-screenshots/analyze-a-shape-on-the-map/Time Slider.png') %></p>
  ...
  <p>
    <%= image_tag('howto-screenshots/analyze-a-shape-on-the-map/Analyze-Shape-Tutorial.gif') %>
  </p>
  ...
  <div class="img-two-columns">
    <%= image_tag('howto-screenshots/analyze-a-shape-on-the-map/Log In Window.png') %>
    <%= image_tag('howto-screenshots/analyze-a-shape-on-the-map/Subscribe to Alerts.png') %>
    <%= image_tag('howto-screenshots/analyze-a-shape-on-the-map/Name Your Subscription.png') %>
    <%= image_tag('howto-screenshots/analyze-a-shape-on-the-map/Subscription Saved.png') %>
  </div>
  ...
  <p><%= image_tag('howto-screenshots/analyze-a-shape-on-the-map/My GFW Drop Down.png') %></p>
</div>
