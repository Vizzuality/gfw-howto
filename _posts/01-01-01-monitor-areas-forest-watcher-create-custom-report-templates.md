...
<div id="desktopContent" class="content">
  ...
  <p><strong>4.</strong> To create a new report template:</p>
    <ul>
      ...
      <p><img src="{{site.sub_url}}{{page.imagepath}}/desktop/12d.png"/></p>
      <li>Choose a language for the report.</li>
      <li>Add a title for your report.</li>
      <p><img src="{{site.sub_url}}{{page.imagepath}}/desktop/12e.png"/></p>
      ...
      <p><img src="{{site.sub_url}}{{page.imagepath}}/desktop/12f.png"/></p>
      <li>If you’re ready to release the report, change the toggle from “Unpublished” to “Published,” and click "Save".</li>
      <p><img src="{{site.sub_url}}{{page.imagepath}}/desktop/12g.png"/></p>
    </ul>
  ...
  <p><img src="{{site.sub_url}}{{page.imagepath}}/desktop/12h.png"/></p>
  <p><strong>6.</strong> Click on “Download Answers” to download a spreadsheet with all report answers.</p>
  <p><img src="{{site.sub_url}}{{page.imagepath}}/desktop/12i.png"/></p>
